...
### Data diagnostics
It seems that there is one incorrect value (out of range) in both pain and mindfulness. The pain problem seems to be a typo (50 instead of 5) and I will treat it as that, the mindfulness is hard to guess, I will treat is as a maximum value (6).
